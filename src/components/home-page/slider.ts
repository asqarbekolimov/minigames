import candyCrushImage from '@/assets/images/games/candy-crush.jpeg';
import islandersImage from '@/assets/images/games/islanders.jpeg';
import vacationCafeImage from '@/assets/images/games/vacation-cafe.jpeg';
import winterBurrowImage from '@/assets/images/games/winter-burrow.jpeg';
import bubbleShooterImage from '@/assets/images/games/bubble-shooter.jpeg';

const games = [
  { title: 'Candy Crush', image: candyCrushImage, size: 'peek' },
  {
  ...
  { title: 'Winter Burrow', image: vacationCafeImage, rating: '4.9', likes: '32.4K', size: 'side' },
  { title: 'Bubble Shooter', image: bubbleShooterImage, size: 'peek' },
];
...
export function createSliderSection(): HTMLElement {
  ...
  const moveTrack = (direction: 'next' | 'previous') => {
    if (!inner) return;
    inner.style.transform = direction === 'next' ? 'translateX(-176px)' : 'translateX(0)';

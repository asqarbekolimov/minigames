  ...
  form.innerHTML = `
    <div class="login-field">
      ...
      <span class="login-field__control">
        ...
        <input id="login-email" type="email" placeholder="e.g. alex@minigames.com" aria-label="Email Address">
      </span>
    </div>
    ...
    <div class="login-field">
      ...
      <span class="login-field__control">
        ...
        <input id="login-password" class="password-input" type="password" placeholder="********" aria-label="Password">
...
function createActionsMarkup(submitText: string): string {
  return `
    <div class="login-actions">
      <button class="login-actions__submit" type="submit">${submitText}</button>
